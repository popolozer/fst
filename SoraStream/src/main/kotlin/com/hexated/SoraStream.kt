...
open class SoraStream : TmdbProvider() {
    ...
    override val mainPage = mainPageOf(
        "$tmdbAPI/trending/all/day?api_key=$apiKey&region=FR" to "Trending",
        "$tmdbAPI/movie/popular?api_key=$apiKey&region=FR" to "Popular Movies",
        "$tmdbAPI/tv/popular?api_key=$apiKey&region=FR&with_original_language=en" to "Popular TV Shows",
        "$tmdbAPI/tv/airing_today?api_key=$apiKey&region=FR&with_original_language=en" to "Airing Today TV Shows",
//        "$tmdbAPI/tv/on_the_air?api_key=$apiKey&region=FR" to "On The Air TV Shows",
        ...
        "$tmdbAPI/movie/top_rated?api_key=$apiKey&region=FR" to "Top Rated Movies",
        "$tmdbAPI/tv/top_rated?api_key=$apiKey&region=FR" to "Top Rated TV Shows",
        "$tmdbAPI/movie/upcoming?api_key=$apiKey&region=FR" to "Upcoming Movies",
